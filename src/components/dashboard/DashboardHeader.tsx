    ...
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12 lg:mb-16">
      <div className="flex items-center gap-6">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-black tracking-tighter uppercase mb-2 italic leading-tight">{title}</h1>
      ...
      {showStats && (
        <div className="bg-zinc-900/80 border border-zinc-800 p-6 rounded-[2rem] min-w-[140px] shadow-xl">
          <p className="text-zinc-500 text-[10px] font-black uppercase tracking-widest mb-2">{statsLabel}</p>
          <div className="flex items-end gap-2">
            <span className="text-4xl font-black text-amber-500 leading-none">{statsValue}</span>
